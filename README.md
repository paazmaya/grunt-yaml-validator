...
This plugin requires [Grunt](http://gruntjs.com/) `>=0.4.0` and [Node.js](https://nodejs.org/en/) minimum of `6.9.5`, which is [the Long Term Support (LTS) version](https://github.com/nodejs/LTS#lts-schedule1).
